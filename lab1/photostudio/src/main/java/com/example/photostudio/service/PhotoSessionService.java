...
public class PhotoSessionService {
    ...
    public List<PhotoSessionAdminResponseDto> getPhotoSessionForAdminClientFullName(String clientLastName,
            String clientName) {
    ...
    public PhotoSessionAdminResponseDto updatePhotoSessionFormAdmin(Long id, PhotoSessionAdminResponseDto adminDto) {
